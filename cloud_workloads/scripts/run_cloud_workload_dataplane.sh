...
bench_target="dataplane"
bench_option="dataplane"
...
echo 4000 | sudo tee /sys/kernel/mm/ksm/pages_to_scan >/dev/null
echo 0   | sudo tee /sys/kernel/mm/ksm/sleep_millisecs >/dev/null
...
sudo insmod /home/bask_eurosys26/bask_ae_eurosys26/codes/bask/dataplane_client_bridge.ko debug=0 || true
